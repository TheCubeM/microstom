...
// From https://github.com/Minestom/Minestom/blob/master/demo/src/main/java/net/minestom/demo/commands/GamemodeCommand.java
// Licensed under Apache 2.0, modified to use hasPermission instead of permission levels
